...
@JsonTypeName(TypesOfMessage.JOINED_ROOMS)
public class JoinedRoomsResponse extends BasicPackage {
    private List<String> roomsName;

    @SuppressWarnings("unused")
    public JoinedRoomsResponse() {
        super();
    }

    public JoinedRoomsResponse(int messageId, List<String> roomsName) {
        super(messageId);
